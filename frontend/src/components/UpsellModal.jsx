...
const TIERS = [
  {
    ...
    bg: 'bg-blue-500/5',
    features: [
      'Live Keyword Search (50 credits)',
      '"In X carts" demand signals',
      '1-Click Supplier Finder',
      'Calculator Presets',
  ...
  },
  {
    ...
    badge: 'Most Popular',
    features: [
      'Deep Scan (150 credits)',
      'Historical Price Graphs',
      'Copy-Paste SEO keywords',
      'Market Saturation Badges',
  ...
  },
  {
    ...
    features: [
      '500+ Credits/month',
      'Store Spy (full store scrape)',
      '"Do Not Sell" Warning List',
      'Weekly Breakout Email Alerts',
      'CSV Data Export',
